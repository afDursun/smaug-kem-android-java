...
import com.sak.smaugkem.Model.SecurityLevel;
...
public class SmaugKEM {
        ...
        public static  int CRYPTO_BYTES = SHARED_SECRET_BYTES;

        public static  int ID_BYTES;
        public static  int PW_BYTES;

        public static  int CTPOLY1_BYTES = LWE_N;
        public static int CTPOLY2_BYTES ;

        public static  int SKPOLYVEC_BYTES = HS;
